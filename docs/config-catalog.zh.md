...
export interface Config {
  ...
  tools?: ToolsConfig
  /** DeepSeek Harness home directory used for local skill discovery. */
  dshHome?: string
...
来源：[`packages/shell/bash-sandbox/src/index.ts:34`](../packages/shell/bash-sandbox/src/index.ts)
...
export interface BasicCompactionConfig extends CompactionPolicyConfig {
  ...
  /** Enable automatic step-boundary pressure and overflow-recovery listeners. Defaults to `false`. */
  auto?: boolean
}
...
来源：[`packages/shell/pwsh-sandbox/src/index.ts:39`](../packages/shell/pwsh-sandbox/src/index.ts)
...
来源：[`packages/fs/tool-str-replace-editor/src/index.ts:487`](../packages/fs/tool-str-replace-editor/src/index.ts)
...
- `@deepseek-ai/dsh-shell-env`（[`packages/shell/shell-env/src/index.ts`](../packages/shell/shell-env/src/index.ts)）
