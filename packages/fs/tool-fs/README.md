...
- **Escalation widens a mode** — an approved outside-root read currently retries under `danger-full-access`; root-scoped grants remain separate policy work.
