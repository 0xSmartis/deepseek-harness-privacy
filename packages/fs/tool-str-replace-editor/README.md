...
- Every operation resolves the current session sandbox policy and delegates enforcement to the mounted filesystem. Mutations additionally go through `fs/write-intent` or `fs/edit-intent`.
