...
- **Windows child-network enforcement is partial** — the ACL runner has no independent IP-network mechanism. The provider reports `networkEnforcement: 'partial'`; shell and terminal consumers refuse to spawn rather than silently permit networking.
